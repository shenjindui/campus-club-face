		...
		<div class="header-wrap">
			<el-menu :default-active="activeIndex" class="header computerNav" background-color="#9a0e14" mode="horizontal" text-color="#fff" active-text-color="#ffd04b">
				...
				<el-submenu index="3">
					...
					<el-menu-item index="3-1"><router-link :to="{ name: 'PassageList', query: { passageTypeId: 1 } }" tag="div">社团要闻</router-link></el-menu-item>
					<el-menu-item index="3-2"><router-link :to="{ name: 'PassageList', query: { passageTypeId: 2 } }" tag="div">重要公告</router-link></el-menu-item>
				</el-submenu>
				<el-submenu index="4">
					<template slot="title">
						社团风采
...
export default {
  data () {
    return {
      activeIndex: '1',
      adminAccessUrl: 'http://localhost:8081/#/login'
    }
  },
  methods: {
...
export default {
  data () {
    return {
      activeIndex: '1',
      adminAccessUrl: 'http://106.54.55.188:8081/#/login'
		/*adminAccessUrl: 'http://localhost:8081/#/login'*/
    }
  },
  methods: {
